...
with open("../final_project/final_project_dataset_modified.pkl", "rb") as file:
    dictionary = joblib.load(file)
...
r2 = r2_score(target_test, y_pred=reg.predict(feature_test))
